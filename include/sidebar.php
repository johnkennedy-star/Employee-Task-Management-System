...
<head>
  ...
  <link rel="stylesheet" href="./assets/datepicker/css/datepicker-custom.css">
  <link rel="stylesheet" href="./assets/css/custom.css">
  <script src="./assets/js/jquery.min.js"></script>
  <script src="./assets/js/nom.js"></script>
  <script src="./assets/js/custom.js"></script>
  <script src="./assets/datepicker/js/datepicker.js"></script>
  <script src="./assets/datepicker/js/datepicker-custom.js"></script>
